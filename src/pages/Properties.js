            ...
            <SwiperSlide>
              ...
              <Card className="bg-black-100 rounded">
                <Card.Body className="p-2">
                  ...
                  <h5 className="mt-2 primary-text fw-normal">
                    Cottage «Forrest 1»
                  </h5>
                  ...
                  <div className="d-flex">
                    ...
                    <div>
                      <h6 className="primary-text">29.71 ETH</h6>
            ...
            <SwiperSlide>
              ...
              <Card className="bg-black-100 rounded">
                <Card.Body className="p-2">
                  ...
                  <h5 className="mt-2 primary-text fw-normal">Freshness</h5>
                  ...
                  <div className="d-flex">
                    ...
                    <div>
                      <h6 className="primary-text">14.81 ETH</h6>
                      <span className="gray-90">Current Bid</span>
                    </div>
                  </div>
                </Card.Body>
            ...
            <SwiperSlide>
              ...
              <Card className="bg-black-100 rounded">
                <Card.Body className="p-2">
                  ...
                  <h5 className="mt-2 primary-text fw-normal">Wish house</h5>
                  ...
                  <div className="d-flex">
                    ...
                    <div>
                      <h6 className="primary-text">16.62 ETH</h6>
                      <span className="gray-90">Current Bid</span>
                    </div>
                  </div>
                </Card.Body>
            ...
            <SwiperSlide>
              ...
              <Card className="bg-black-100 rounded">
                <Card.Body className="p-2">
                  ...
                  <h5 className="mt-2 primary-text fw-normal">Spruce</h5>
                  ...
                  <div className="d-flex">
                    ...
                    <div>
                      <h6 className="primary-text">17.01 ETH</h6>
                      <span className="gray-90">Current Bid</span>
                    </div>
                  </div>
                </Card.Body>
            ...
            <SwiperSlide>
              ...
              <Card className="bg-black-100 rounded">
                <Card.Body className="p-2">
                  ...
                  <h5 className="mt-2 primary-text fw-normal">Residence Rybna</h5>
                  <p className="gray-90">@UA real estate agency</p>
                  <div className="d-flex">
                    <div className="me-3">
            ...
            <SwiperSlide>
              ...
              <Card className="bg-black-100 rounded">
                <Card.Body className="p-2">
                  ...
                  <h5 className="mt-2 primary-text fw-normal">Blue Sky</h5>
                  <p className="gray-90">@ERA Ukraine Real Estate</p>
                  <div className="d-flex">
                    <div className="me-3">
                    ...
                    <div>
                      <h6 className="primary-text">17.31 ETH</h6>
                      <span className="gray-90">Current Bid</span>
                    </div>
                  </div>
                </Card.Body>
