  ...
  return (
    <div className="loading position-relative">
      <Container className="d-flex justify-content-between align-items-center gap-md-5 flex-column flex-md-row mt-3 mt-xl-4 overflow-hidden">
        ...
        >
          <AnimationTitles title="Future of real estate investing" className="clr-primary-text" />
          ...
          <div
            className="d-none d-md-flex justify-content-between align-items-center my-4 primary-text"
          >
            <div>
